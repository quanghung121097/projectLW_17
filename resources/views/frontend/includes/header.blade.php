										...
										<div class="custom_dropdown">
											<div class="custom_dropdown_list">
												...
												<ul class="custom_list clc">
													...
													<li><a class="clc" href="#">Phần cứng</a></li>
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									...
									<div class="cart_content">
										...
										<div class="cart_price">85,000đ</div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									<li><a href="#"> Máy tính và Laptop <i class="fas fa-chevron-right ml-auto"></i></a></li>
									<li><a href="#">Máy ảnh<i class="fas fa-chevron-right"></i></a></li>
									<li class="hassubs">
										<a href="#"> Phần cứng<Phclass="fas fa-chevron-right"></i></a>
										<ul>
											<li class="hassubs">
									...
									<li><a href="#">Điện thoại và máy tính bảng<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="#">TV & Âm thanh<i class="fas fa-chevron-right"></i></a></li>
