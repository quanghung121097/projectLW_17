		...
		<div class="row">
			...
			<div class="col-lg-2 order-lg-1 order-2">
				<ul class="image_list">
					...
					<li data-image="/{{$img->path}}"><img src="/{{$img->path}}" alt="" ></li>
					@endforeach
					@endif
				</ul>
			</div>
			...
			<div class="col-lg-5 order-3">
				<div class="product_description">
					...
					<div class="order_info d-flex flex-row">
						<form action="{{route('frontend.cart.addproduct',$product->id)}}" method="post">
							@csrf
							...
							<div class="product_price">
								...
								<p style="font-size: 15px "><i>Giá gốc:<br></i></p>
								<strike>{{number_format($product->origin_price)}}</strike><i>Vnđ</i>
								<p style="font-size: 30px; " ><i>Giá bán:</i><br> <div style="color: #FA5858">{{number_format($product->sale_price)}} Vnđ</div></p>
								@else
								<p style="font-size: 30px; " ><i>Giá bán:</i><br> <div style="color: #FA5858">{{number_format($product->sale_price)}} Vnđ</div></p>
								@endif
