                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($oder->status==0)
                                    <a style="display: inline-block;" href="" class="btn btn-danger"><i class="fas fa-truck"></i></a>
                                    @endif
                                    @if($oder->status==1)
                                    <a style="display: inline-block;" href="" class="btn btn-success"><i class="fas fa-clipboard-check"></i></i></a>
                                    @endif
